...
import cable.social.app.adapters.UsersAdapter;
...
import cable.social.app.utils.PushNotificationSender;
...
public class OpponentsActivity extends BaseActivity {
    ...
    String videoFile="",videoId="";

    public static void start(Context context,String videoFile,String videoId) {
    ...
    protected void onResume() {
        ...
        if (isCallServiceRunning(CallService.class)) {
            ...
            CallActivity.start(this, isIncomingCall,videoFile,videoId);
        }
...
//                return true;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(OpponentsActivity.this, MainActivity.class);
    ...
    private void startCall(boolean isVideoCall) {
        ...
        CallActivity.start(this, false,videoFile,videoId);
    }
