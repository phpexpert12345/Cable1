...
import cable.social.app.activity.services.CallService;
import cable.social.app.activity.services.LoginService;
import cable.social.app.db.QbUsersDbManager;
import cable.social.app.fragments.AudioConversationFragment;
import cable.social.app.fragments.BaseConversationFragment;
import cable.social.app.fragments.ConversationFragmentCallback;
import cable.social.app.fragments.IncomeCallFragment;
import cable.social.app.fragments.IncomeCallFragmentCallbackListener;
import cable.social.app.fragments.ScreenShareFragment;
import cable.social.app.fragments.VideoConversationFragment;
import cable.social.app.utility.CSPreferences;
import cable.social.app.utils.Consts;
import cable.social.app.utils.ErrorUtils;
import cable.social.app.utils.FragmentExecuotr;
import cable.social.app.utils.PermissionsChecker;
import cable.social.app.utils.QBEntityCallbackImpl;
import cable.social.app.utils.SettingsUtil;
import cable.social.app.utils.SharedPrefsHelper;
import cable.social.app.utils.ToastUtils;
import cable.social.app.utils.UsersUtils;
import cable.social.app.utils.WebRtcSessionManager;
...
public class CallActivity extends BaseActivity implements IncomeCallFragmentCallbackListener,
    ...
    public static String videoFile="",videoId="";

    public static void start(Context context, boolean isIncomingCall,String videoFile,String videoId) {
        Intent intent = new Intent(context, CallActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.putExtra(Consts.EXTRA_IS_INCOMING_CALL, isIncomingCall);
        intent.putExtra("videourl", videoFile);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle!=null){
            videoFile=bundle.getString("videoFile");
            videoId=bundle.getString("videoId");
        }


        Log.v("vidUrl",CSPreferences.readString(CallActivity.this, "videourl"));
