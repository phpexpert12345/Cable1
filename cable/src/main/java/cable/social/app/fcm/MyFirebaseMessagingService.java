...
import cable.social.app.splash.SplashActivity;
import cable.social.app.utility.CSPreferences;
import cable.social.app.utility.Config;
...
//            pushNotification.setAction("videocall");
...
//    }
    ...
    public void sendNotification(RemoteMessage remoteMessage) {
        ...
        NotificationCompat.Builder mBuilder =
            ...
            Map<String, String> data = remoteMessage.getData();
            String customer_id = data.get("customer_id").toString();
            String notification_type = data.get("notification_type").toString();
            String body = data.get("body").toString();
//            String image = data.get("image").toString();
            String title = data.get("title").toString();

            Log.d("remoteMessage", "remoteMessage " + customer_id + " " + notification_type + " " + body  + " " + title);
