...
import cable.social.app.adapters.OpponentsFromCallAdapter;
...
public class VideoConversationFragment extends BaseConversationFragment implements Serializable,
    ...
    private void setGrid(int columnsCount) {
        ...
        opponentsAdapter = new OpponentsFromCallAdapter(getContext(), this, opponents, (int) getResources().getDimension(R.dimen._80sdp),
