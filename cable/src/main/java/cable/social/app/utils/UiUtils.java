package cable.social.app.utils;
...
public class UiUtils {
    ...
    public static Drawable getGreyCircleDrawable() {
        return getColoredCircleDrawable(App.getInstance().getResources().getColor(R.color.cccccc));
    }
    ...
    public static Drawable getColoredCircleDrawable(@ColorInt int color) {
        GradientDrawable drawable = (GradientDrawable) App.getInstance().getResources().getDrawable(R.drawable.blue_solid_circle);
