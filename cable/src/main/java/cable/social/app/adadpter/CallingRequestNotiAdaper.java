...
public class CallingRequestNotiAdaper extends RecyclerView.Adapter<CallingRequestNotiAdaper.ProductViewHolder> {
    ...
    public CallingRequestNotiAdaper(Context mCtx, List<Map<String,String>> productList) {
        this.mCtx = mCtx;
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.video_call_request_item, null);
