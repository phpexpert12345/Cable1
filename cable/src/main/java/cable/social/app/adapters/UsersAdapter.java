package cable.social.app.adapters;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull UsersAdapter.ViewHolder holder, int position) {
        ...
        if (selectedUsers.contains(user)) {
            holder.rootLayout.setBackgroundResource(R.color.color_blue_accent);
            ...
            holder.opponentIcon.setImageResource(R.drawable.ic_check_circle_black_24dp);
        } else {
            holder.rootLayout.setBackgroundResource(R.color.invite_back);
            holder.opponentIcon.setBackgroundDrawable(UiUtils.getColorCircleDrawable(user.getId()));
            holder.opponentIcon.setImageResource(R.drawable.ic_user);
        }
