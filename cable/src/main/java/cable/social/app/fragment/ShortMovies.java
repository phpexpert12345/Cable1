...
public class ShortMovies extends Fragment implements VideoFetched_interface {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (GlobalClass.isNetworkConnected(getActivity())) {
            ...
            categorylist.my_video_list(getActivity(), this, CSPreferences.readString(getActivity(), "tooken"),CSPreferences.readString(getActivity(), "auth_key"),"0");
        } else {
